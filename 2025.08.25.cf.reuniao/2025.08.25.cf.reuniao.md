...
A Seleto Síndicos Profissionais apresentou a imagem a seguir, aparentemente de uma tela, porém sem identificação de endereço de origem, com o título **Informações Gerenciais de Clientes**.
